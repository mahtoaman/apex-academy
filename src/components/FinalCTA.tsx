      ...
      <div className="container-main relative z-10 text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <LeadFormDialog
              trigger={
                <button className="bg-accent text-accent-foreground px-10 py-4 rounded-xl font-bold text-lg hover:bg-accent/90 transition-all hover:shadow-lg hover:shadow-accent/25 flex items-center justify-center gap-2">
                  Apply Now — It's Free
                  <ArrowRight size={20} />
                </button>
              }
